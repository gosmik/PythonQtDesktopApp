...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(550, 130, 241, 441))
        ...
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.FieldRole, self.btnSaveLocation)
        ...
        self.formLayout_2.setWidget(9, QtGui.QFormLayout.FieldRole, self.btnRefreshLocations)
        self.cusLocWidget = QtGui.QListWidget(self.formLayoutWidget_2)
        self.cusLocWidget.setObjectName(_fromUtf8("cusLocWidget"))
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.FieldRole, self.cusLocWidget)
        ...
        self.formLayout_2.setWidget(7, QtGui.QFormLayout.FieldRole, self.newLocationLineEdit)
        self.newLocationLabel = QtGui.QLabel(self.formLayoutWidget_2)
        self.newLocationLabel.setObjectName(_fromUtf8("newLocationLabel"))
        self.formLayout_2.setWidget(7, QtGui.QFormLayout.LabelRole, self.newLocationLabel)
